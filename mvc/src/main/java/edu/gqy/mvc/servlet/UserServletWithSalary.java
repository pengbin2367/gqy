package edu.gqy.mvc.servlet;

import edu.gqy.mvc.povo.User;
import edu.gqy.mvc.service.UserService;
import edu.gqy.mvc.service.impl.UserServiceImpl;
...
@WebServlet("/user.do")
public class UserServletWithSalary extends HttpServlet {
    ...
    private void update(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Double salary = Double.valueOf(request.getParameter("salary_" + updateId));
        User user = new User();
        user.setName(name);
        user.setBirth(birth);
